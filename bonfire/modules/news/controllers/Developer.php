...
{
    protected $permissionCreate = 'News.Developer.Create';
    protected $permissionDelete = 'News.Developer.Delete';
    protected $permissionEdit   = 'News.Developer.Edit';
    protected $permissionView   = 'News.Developer.View';
        ...
        if (isset($_POST['delete'])) {
            ...
            if (is_array($checked) && count($checked)) {
                ...
                if ($result) {
                    ...
                    Template::set_message(lang('news_delete_failure') . $this->news_model->error, 'danger');
                }
            }
        }
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/developer/news/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            ...
            if ( ! empty($this->news_model->error)) {
                Template::set_message(lang('news_create_failure') . $this->news_model->error, 'danger');
            }
        }
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            Template::set_message(lang('news_invalid_id'), 'danger');
        ...
        if (isset($_POST['save'])) {
            ...
            // Not validation error
            if ( ! empty($this->news_model->error)) {
                Template::set_message(lang('news_edit_failure') . $this->news_model->error, 'danger');
            }
        }
