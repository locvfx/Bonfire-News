...
class News_model extends BF_Model
{
    ...
    */
    public function insert($data = [], $auth = null)
    {
    ...
    */
    ...
    {
        if ($id) {
            $trigger_data = ['article_id' => $id, 'data' => $data];
    ...
    */
    public function find_by($field = null, $value = null, $type = 'and')
    {
        ...
        return parent::find_by($field, $value, 'and');
    }
    ...
    */
    ...
    public function format_dropdown()
    {
        ...
        $query = $this->db->select([$key, $value])->get($this->table_name);
